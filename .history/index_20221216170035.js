...
function calculador(valueA, valueB, operation) {
  ...
  if (operation.sun === '+') return sun(valueA, valueB)
  if (operation.sub === '-') return sub(valueA, valueB)
  if (operation.times === '*') return times(valueA, valueB)
  if (operation.divide === '/') return divide(valueA, valueB)
